...
// OpenDefault opens the database at the default path (~/.claude-pulse/pulse.db).
...
// DefaultDBPath returns ~/.claude-pulse/pulse.db.
func DefaultDBPath() string {
	home, err := os.UserHomeDir()
	if err != nil {
		home = "."
	}
	return filepath.Join(home, ".claude-pulse", "pulse.db")
}
